    ...
    if (func == '消耗') {
      ...
      if (thing_name == '重铸石') {
        ...
        for (var j in type) {
          ...
          if (random == 6) {
            equipment[type[j]].atk = Math.round(equipment[type[j]].atk * 100) / 100
            equipment[type[j]].def = Math.round(equipment[type[j]].def * 100) / 100
            equipment[type[j]].HP = Math.round(equipment[type[j]].HP * 100) / 100
            equipment[type[j]].bao = Math.round(equipment[type[j]].bao * 100) / 100
          }
        }
